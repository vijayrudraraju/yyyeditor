...
exports.shows = {
    textArticle: function (doc,req) {
        ...
        var html = templates.render('textArticle.html',req,context);
    ...
    imagesArticle: function (doc,req) {
        ...
        var context = {id:doc._id,title:doc.author,author:doc.author,filenames:doc.filenames,dbname:req.info.db_name};
        var html = templates.render('imagesArticle.html',req,context);
    ...
    videosArticle: function (doc,req) {
        ...
        var context = {id:doc._id,title:doc.author,author:doc.author,videos:doc.videos,dbname:req.info.db_name};
        var html = templates.render('videosArticle.html',req,context);
    ...
    musicArticle: function (doc,req) {
        ...
        var context = {id:doc._id,title:doc.author,author:doc.author,tracks:doc.tracks,dbname:req.info.db_name};
        var html = templates.render('musicArticle.html',req,context);
