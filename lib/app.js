...
exports.shows = {
    article: function (doc,req) {
        ...
        var context = {title:doc.title,author:doc.author,sections:formattedSections,page_id:doc._id,is_new:doc.is_new};
    ...
    settings: function (doc,req) {
        var templates = require('duality/templates');
        var context = {};
        var html = templates.render('settings.html',req,context);
        return html;
    }
};
